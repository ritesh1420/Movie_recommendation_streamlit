...
with st.sidebar:
    ...
    st.markdown('<a href="https://github.com/Ayushsaini04" target="_blank" style="color: #ff5733;">'
                '<img src="https://img.shields.io/badge/GitHub-Profile-green?style=social&logo=github" alt="GitHub"></a>', 
                unsafe_allow_html=True)
    
    # LinkedIn link with a different colorstream
    st.markdown('<a href="https://www.linkedin.com/in/ayu-sh-/" target="_blank" style="color: #3399FF;">'
